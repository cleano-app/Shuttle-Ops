...
import { portalLogin, type PortalAuthState } from "@/app/actions/portalAuth";
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <form action={formAction} className="w-full max-w-sm rounded-lg bg-white p-8 shadow">
        ...
        <p className="mb-6 text-sm text-slate-500">{t("auth_sign_in")}</p>
        ...
        />
        <Link href="/portal/forgot-password" className="mb-4 block text-right text-sm text-slate-500 underline">
